...
{
	/*
	 * 	Specific ADReader for reading JSON data.
	 * 
	...
	public class ADJSONReader : ADReader
	{
		...
		internal ADJSONReader(Stream stream, ADSettings settings, bool readHeaderAndFooter = true) : base(settings, readHeaderAndFooter)
		{
