...
{
	internal class ADJSONWriter : ADWriter
	{
		internal StreamWriter baseWriter;

		private bool isFirstProperty = true;

		public ADJSONWriter(Stream stream, ADSettings settings) : this(stream, settings, true, true){}

		internal ADJSONWriter(Stream stream, ADSettings settings, bool writeHeaderAndFooter, bool mergeKeys) : base(settings, writeHeaderAndFooter, mergeKeys)
		{
